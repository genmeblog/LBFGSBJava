...
public final class ThreeHumpCamel implements IGradFunction {
	...
	public static void main(String[] args) {
		...
		try {
//			double[] res = lbfgsb.minimize(new Camel(), new double[] { -2, -2 }, new double[] { -5, -5 },
//					new double[] { 5, 5 });
			double[] res = lbfgsb.minimize(new ThreeHumpCamel(), new double[] { 2, 2 }, new double[] { 0, -5 }, new double[] { 1, 1 });
